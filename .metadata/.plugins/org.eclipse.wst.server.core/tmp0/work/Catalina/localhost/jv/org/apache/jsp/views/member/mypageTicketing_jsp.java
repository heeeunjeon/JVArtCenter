 ...
 * Generated at: 2022-11-13 09:02:57 UTC
...
public final class mypageTicketing_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("com.kh.reservation.model.vo.Reservation");
 ...
 if(loginUser == null) { 
	...
	ArrayList<Reservation> list = (ArrayList<Reservation>)request.getAttribute("list");
      ...
      out.write("/* #content { height: 2000px; } */\r\n");
      out.write("#mypage_text {\r\n");
      out.write("	font-size: 40px;\r\n");
      out.write("	font-weight: bold;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#mypage_menuName {\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#mypage_Ticketing_LookUp {\r\n");
      out.write("	width: 1013px;\r\n");
      out.write("	margin: 30px;\r\n");
      out.write("	font-size: 15px;\r\n");
      out.write("	text-align: center;\r\n");
      out.write("	padding: none !important;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#mypage_Ticketing_LookUp td {\r\n");
      out.write("	padding: 15px;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#mypage_Ticketing_btn {\r\n");
      out.write("	float: right;\r\n");
      out.write("	padding: 20px;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("#mypage_Ticketing_LookUp>thead th { font-size: 17px; }\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("</style>\r\n");
      out.write("</head>\r\n");
	...
	String path = request.getContextPath();
      ...
      out.write("\r\n");
      out.write("					<div id=\"mypage_menuName\">최근 예매 내역</div>\r\n");
      out.write("					<!-- 검색 필터 및 버튼 -->\r\n");
      out.write("					<div id=\"mypage_Ticketing_btn\">\r\n");
      out.write("						<button value=\"3\" class=\"btn btn-outline-primary\" onclick=\"search3Months();\">3개월</button>\r\n");
      out.write("						<button value=\"6\" class=\"btn btn-outline-primary\" onclick=\"search6Months();\">6개월</button>\r\n");
      out.write("						&emsp; <input type=\"date\" id=\"startResvDate\" class=\"form-control\">\r\n");
      out.write("						&nbsp;~&nbsp;<input type=\"date\" id=\"endResvDate\" class=\"form-control\">\r\n");
      out.write("						<button type=\"button\" class=\"btn btn-primary\" onclick=\"searchResvDate();\">검색</button>\r\n");
      out.write("					</div>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("					<!-- 예매내역 리스트  -->\r\n");
      out.write("					<table id=\"mypage_Ticketing_LookUp\" class=\"table table-hover\">\r\n");
      out.write("						<thead>\r\n");
      out.write("							<tr style=\"background-color: black; color: white;\">\r\n");
      out.write("								<th width=\"200\">전시명</th>\r\n");
      out.write("								<th width=\"90\">관람일자</th>\r\n");
      out.write("								<th width=\"70\">수량</th>\r\n");
      out.write("								<th width=\"70\">결제금액</th>\r\n");
      out.write("								<th width=\"70\">결제여부</th>\r\n");
      out.write("								<th width=\"70\">상세내역</th>\r\n");
      out.write("							</tr>\r\n");
      out.write("						</thead>\r\n");
      out.write("						<tbody>\r\n");
      out.write("							");
 if(list.isEmpty()) { 
      out.write("\r\n");
      out.write("								<tr>\r\n");
      out.write("									<td colspan=\"6\">최근 예매내역이 없습니다.</td>\r\n");
      out.write("								</tr>\r\n");
      out.write("							");
 } else { 
      out.write("\r\n");
 ...
 for(Reservation rv : list) { 
      ...
      out.write("									<tr>\r\n");
      out.write("										<td>");
      out.print( rv.getExNo() );
      out.write("</td>\r\n");
      out.write("										<td>");
      out.print( rv.getResvDate() );
      out.write("</td>\r\n");
      out.write("										<td>");
      out.print( rv.getCount() );
      out.write("</td>\r\n");
      out.write("										<td>");
      out.print( rv.getPayment() );
      out.write("</td>\r\n");
      out.write("										");
 if(rv.getPayStatus().equals("Y")) { 
      ...
      out.write("												<a href=\"");
      out.print( contextPath );
      out.write("/mypageTicketingDetail.bo?rno=");
      out.print( rv.getResvNo() );
      out.write("\" class=\"btn-link\">상세보기</a>\r\n");
      out.write("											</td>\r\n");
      out.write("										");
 } else if(rv.getPayStatus().equals("C")) { 
      out.write("\r\n");
      out.write("											<td>취소환불</td>\r\n");
      out.write("											<td>\r\n");
      out.write("												<a href=\"");
      out.print( contextPath );
      out.write("/mypageTicketingDetail.bo?rno=");
      ...
      out.write("					\r\n");
      out.write("					<script>\r\n");
      out.write("						function search3Months() {\r\n");
      out.write("		\r\n");
      out.write("							$.ajax({\r\n");
      out.write("								url : \"ticketingSearch3.me\",\r\n");
      ...
      out.write("										for(var i = 0; i < result.length; i++) {\r\n");
      out.write("											\r\n");
      out.write("											if(result[i].payStatus === \"Y\") {\r\n");
      out.write("												status = \"결제완료\";\r\n");
      out.write("											} else if(result[i].payStatus === \"C\") {\r\n");
      out.write("												status = \"취소완료\";		\r\n");
      out.write("											} else {\r\n");
      out.write("												status = \"미결제\";\r\n");
      out.write("											}\r\n");
      out.write("										\r\n");
      out.write("											str += \"<tr>\"\r\n");
      out.write("												+ 		\"<td>\" + result[i].exNo + \"</td>\"\r\n");
      out.write("												+ 		\"<td>\" + result[i].resvDate + \"</td>\"\r\n");
      out.write("												+ 		\"<td>\" + result[i].count + \"</td>\"\r\n");
      out.write("												+ 		\"<td>\" + result[i].payment + \"</td>\"\r\n");
      out.write("												+		\"<td>\" + status + \"</td>\"\r\n");
      out.write("												+		\"<td><a href='");
      out.print( contextPath );
      out.write("/mypageTicketingDetail.bo?rno=\" + result[i].resvNo + \"' class='btn-link'>상세보기</a></td>\"\r\n");
      out.write("												+ \"</tr>\";\r\n");
      out.write("										}\r\n");
      out.write("										\r\n");
      out.write("									} else {\r\n");
      out.write("		\r\n");
      out.write("										str = \"<tr><td colspan='6'>3개월 이내 예매내역이 없습니다.</td></tr>\";\r\n");
      out.write("										\r\n");
      out.write("									}\r\n");
      out.write("		\r\n");
      out.write("									$(\"#mypage_Ticketing_LookUp>tbody\").html(str);\r\n");
      out.write("		\r\n");
      out.write("								},\r\n");
      out.write("								error : function() {\r\n");
      out.write("									console.log(\"ajax 통신 실패\");\r\n");
      ...
      out.write("						}\r\n");
      out.write("						\r\n");
      out.write("						function search6Months() {\r\n");
      out.write("							\r\n");
      out.write("							$.ajax({\r\n");
      out.write("								url : \"ticketingSearch6.me\",\r\n");
      out.write("								data : { memNo : ");
      out.print( loginUser.getMemNo() );
      out.write(" },\r\n");
      out.write("								success : function(result) {\r\n");
      ...
      out.write("									} else {\r\n");
      out.write("		\r\n");
      out.write("										str = \"<tr><td colspan='6'>6개월 이내 예매내역이 없습니다.</td></tr>\";\r\n");
      out.write("										\r\n");
      out.write("									}\r\n");
      out.write("		\r\n");
      out.write("									$(\"#mypage_Ticketing_LookUp>tbody\").html(str);\r\n");
      ...
      out.write("						}\r\n");
      out.write("						\r\n");
      out.write("						function searchResvDate() {\r\n");
      out.write("							\r\n");
      out.write("							var start = new Date($(\"#startResvDate\").val());\r\n");
      out.write("							start.setHours(0, 0, 0, 0);\r\n");
      out.write("							var end = new Date($(\"#endResvDate\").val());\r\n");
      out.write("							end.setHours(0, 0, 0, 0);\r\n");
      out.write("							\r\n");
      out.write("							if(end < start) {\r\n");
      out.write("								alert(\"조회하신 기간이 올바르지 않습니다.\\n시작일은 반드시 종료일보다 과거여야 합니다.\");\r\n");
      out.write("							} else {\r\n");
      out.write("								\r\n");
      out.write("								$.ajax({\r\n");
      out.write("									url : \"ticketingSearchDate.me\",\r\n");
      out.write("									data : {\r\n");
      out.write("										memNo : ");
      out.print( loginUser.getMemNo() );
      out.write(",\r\n");
      out.write("										startDate : $(\"#startResvDate\").val(),\r\n");
      out.write("										endDate : $(\"#endResvDate\").val()\r\n");
      out.write("									},\r\n");
      out.write("									success : function(result) {\r\n");
      out.write("										\r\n");
      out.write("										var str = \"\";\r\n");
      ...
      out.write("										} else {\r\n");
      out.write("			\r\n");
      out.write("											str = \"<tr><td colspan='6'>검색하신 기간의 예매내역이 없습니다.</td></tr>\";\r\n");
      out.write("											\r\n");
      out.write("										}\r\n");
      out.write("			\r\n");
      out.write("										$(\"#mypage_Ticketing_LookUp>tbody\").html(str);\r\n");
